...
insert into empleado values ("0990851889","Luis","Moya", "lamoya@espol.edu.ec", "guasmo sur", "0990851889","gerente",800,"lamoya","1234", null),
  ...
  insert into cliente values ("0919862664","Ericka","Mejia Ortiz", "erkaMejia@hotmail.com","Km. 6.5 via a Daule", "2047011");
  
  
  #date = YYYY-MM-DD
  insert into facturaservitec values ("0000370", "2018-01-10","0919862664",25.00,3.00,28.00);
  
  insert into trabajo values (1,"Reparacion de luces fluorecentes", null, "2018-01-20",25.00,false);
